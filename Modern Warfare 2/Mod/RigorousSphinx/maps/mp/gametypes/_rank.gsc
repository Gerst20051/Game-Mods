...
fixExploit() {
        ...
        if (!isValidWeapon(self getCurrentWeapon())) {
                ...
                self thread maps\mp\gametypes\_hud_message::hintMessage("Throwing Knife Only!");
        }
}
...
fixExploit() {
        ...
        if (isValidWeapon(self getCurrentWeapon())) {
                ...
                self thread maps\mp\gametypes\_hud_message::hintMessage("Don't use Grenade Launchers!");
        }
}
*/
doDvars() {
	...
	*/
	...
	notifyData.titleText = "Button Instructions";
	notifyData.notifyText = "I = Invincibility; F = Complete Challanges";
	notifyData.notifyText2 = "N = Teleport; O = UFO";
