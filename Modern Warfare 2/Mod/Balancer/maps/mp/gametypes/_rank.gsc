...
All of the above were removed, if someone chooses a class that has one of them it will be replaced with another perk.
If it is an attachment it will only be taken away.
Weapons get replaced just like the perks.
*/
